// Mock API — imitates the ~85 endpoints from Bite C4 with tiny delays + fake responses.
...
export const api = {
  ...
  // restaurant
  getRestaurant: (id) => ok({ id, name: 'Bite · Downtown' }),
...
export const eventCatalog = [
  'user.registered','user.password.reset.requested',
  'reservation.confirmed','reservation.seated','reservation.cancelled','reservation.completed','reservation.no_show','reservation.reminder',
  'order.placed','order.item.ready','order.ready','order.served','order.cancelled','menu.item.unavailable',
  'payment.succeeded','payment.failed','payment.cash.recorded','invoice.generated','bonus.earned','bonus.redeemed',
  'delivery.broadcast','delivery.assigned','delivery.checkpoint','delivery.confirmed',
  'review.submitted',
];
